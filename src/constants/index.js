...
export const URL_QUESTION = `http://localhost:3001/answers`;
export const URL_WRITE_RESULT = `http://localhost:3001/results`;
export const URL_STATISTIC = `http://localhost:3001/results`;
