...
import {startGame} from "../AC/index"
  ...
  render() {
    ...
    return (
      <section className="main main--welcome">
        ...
        <button onClick={startGameRequest} className="main-play">Начать игру</button>
...
export default connect(null, {startGame})(WelcomeScreen);
